/****************************************************************/
/*    NAME: rerun_MONICA_twostage_perth.sas                     */
...
%runfil(cent=10, repunit=99, taurat=400); * smaller tau ratio gives more flexible trend;
...
filename graph1 "U:\Research\Projects\ihbi\aushsi\aushsi_barnetta\meta.research\reproducibility.challenge\updated_files\plots\periodogram_twostage_perth.eps";
...
run; quit;
filename graph1 "U:\Research\Projects\ihbi\aushsi\aushsi_barnetta\meta.research\reproducibility.challenge\updated_files\plots\trend_twostage_perth.eps";
goptions reset=all ftext=centx htext=3 gunit=pct colors=(black) gunit=pct noborder
    gsfname=graph1 noprompt gsfmode=replace device=PSLEPSF fontres=presentation dash;
...
axis2 minor=NONE label=(a=90 'CHD Rate per 100,000') order=(10 to 50 by 10);
