/****************************************************************/
/*    NAME: rerun_MONICA_twostage_warsaw.sas                    */
...
%runfil(cent=36, repunit=99, taurat=900); * smaller tau ratio gives more flexible trend;
...
filename graph1 "U:\Research\Projects\ihbi\aushsi\aushsi_barnetta\meta.research\reproducibility.challenge\updated_files\plots\periodogram_twostage_warsaw.eps";
...
run; quit;
filename graph1 "U:\Research\Projects\ihbi\aushsi\aushsi_barnetta\meta.research\reproducibility.challenge\updated_files\plots\trend_twostage_warsaw.eps";
goptions reset=all ftext=centx htext=3 gunit=pct colors=(black) gunit=pct noborder
    gsfname=graph1 noprompt gsfmode=replace device=PSLEPSF fontres=presentation dash;
...
axis2 minor=NONE label=(a=90 'CHD Rate per 100,000') order=(20 to 80 by 10);
